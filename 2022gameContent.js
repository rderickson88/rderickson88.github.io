myData = [
    ...
    "Sum": "This is a unique 'Pac-Man' style game that was built for up to 2 players to collect various candy pieces on a variety of maps. Use the 'Tab' button on the main menu to enable the two player mode. Arrow keys control Player 1, WASD controls player 2.", 
    ...
    {"Title": "Fenrir - Jesse", 
    "Sum": "A twin-stick shooter designed with consoles in mind. There is a robus ammo and shield system. Test your mettle against an ever-challenging horde of enemy combatants. This will only work with X-input controllers, like an XBOX controller. Be warned!", 
    "Editor": "This is Mr. E's Commentary", 
